...
export default function ChatHeader({ title, optimisticTitle, chatId, sidebarOpen }: ChatHeaderProps) {
  ...
  return (
    <header className={`relative z-10 flex items-center justify-between border-b border-border-subtle/20 bg-background/80 px-6 py-4 backdrop-blur-md ${sidebarOpen === false ? 'pl-32' : ''}`}>
